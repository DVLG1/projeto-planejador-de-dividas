...
**🔎 Mock Bacen/SCR (importar dívidas por CPF)**
- `POST /api/mock/serasa/import` - Importa dívidas mock para um usuário a partir do CPF

Exemplo de requisição (JSON):
```json
{ "cpf": "12345678900", "usuarioId": 1 }
```

Resposta: lista de dívidas criadas (entidades `Divida`) associadas ao usuário informado.
Use este endpoint para popular rapidamente o banco com dívidas de teste sem precisar criar cada dívida manualmente.
